...
insert into products (name, description, code, price) values ('Oreo Original Cookies', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.

Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.
In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.', '816905633-0', 8.47);

insert into products (name, description, code, price) values (' Oreo White', 'Oreo omhuld met een heerlijke laag witte chocolade.'
, '077030122-3', 3);
